...
$odemelerArry = array("Tedarikci Ödemesi","Müşteri Ödemesi");
foreach ($odemelerArry as $key => $adi) { 
    $kistas = "`adi` = '$adi'";
    $varmi = VarmiKontrol($dataAdi, $kistas);
    if($varmi == 0) {
        $saveValues = "NULL, '$adi'";
        addToSql($dataAdi,$saveValues,$odemeturDataKolonlar);
    }
}
?>
      ...
      <div class="main_container">
        ...
        <div class="page-title">
              <div class="title_left">
                <h3>Bakkal Yönetim Paneline Hoşgeldiniz</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title" style="margin-top:20px; border-bottom: none;">
                    <h2>Lütfen Seçiminizi Yapınız</h2>
                    </div></div></div></div>
